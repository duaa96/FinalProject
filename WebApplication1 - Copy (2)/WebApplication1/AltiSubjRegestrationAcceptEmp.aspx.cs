...
{
    public partial class AltiSubjRegestrationAcceptEmp : System.Web.UI.Page
    {
        ...
        private void fillGv()
        {
            ...
            DataTable TBL1 = obj.dtNotAcceptAliSubRegApplication();
        ...
        public void NotAccept(int ID)
        {
            ...
            if (obj.NotAcceptRegAltiSubj(ID) == 1)
            {
                fillGv();
            }
