...
{
    public partial class DropSemesterHeadEmp : System.Web.UI.Page
    {
        ...
        private void fillGv()
        {
            ...
            DataTable TBL1 = obj.dtNotAcceptDropSemesterHeadApplication();
        ...
        public void Accept(int ID)
        {
            ...
            if (obj.AcceptHeadDropSemester(ID) == 1)
            {
                fillGv();
            }
