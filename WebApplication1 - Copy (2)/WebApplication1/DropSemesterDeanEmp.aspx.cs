...
{
    public partial class DropSemesterDeanEmp : System.Web.UI.Page
    {
        ...
        private void fillGv()
        {
            ...
            DataTable TBL1 = obj.dtNotAcceptDropSemesterDeanApplication();
        ...
        public void Accept(int ID)
        {
            ...
            if (obj.AcceptDeanDropSemester(ID) == 1)
            {
                fillGv();
            }
        ...
        public void NotAccept(int ID)
        {
            ...
            if (obj.NotAcceptDeanDropSemester(ID) == 1)
            {
                fillGv();
            }
