...
{
    public partial class DropSemesterAcademicAdvisorAcceptEmp : System.Web.UI.Page
    {
        ...
        private void fillGv()
        {
            ...
            DataTable TBL1 = obj.dtNotAcceptDropSemesterAcademicAdvisorApplication();
        ...
        public void NotAccept(int ID)
        {
            ...
            if (obj.NotAcceptAcademicAdvisorDropSemester(ID) == 1)
            {
                fillGv();
            }
