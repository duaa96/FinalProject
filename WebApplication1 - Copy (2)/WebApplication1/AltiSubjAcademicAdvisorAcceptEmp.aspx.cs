...
{
    public partial class AltiSubjAcademicAdvisorAcceptEmp : System.Web.UI.Page
    {
        ...
        private void fillGv()
        {
            ...
            DataTable TBL1 = obj.dtNotAcceptAliSubAcademicAdvisorApplication();
        ...
        public void Accept(int ID)
        {
            ...
            if (obj.AcceptAcademicAdvisorAltiSubj(ID) == 1)
            {
                fillGv();
            }
        ...
        public void NotAccept(int ID)
        {
            ...
            if (obj.NotAcceptAcademicAdvisorAltiSubj(ID) == 1)
            {
                fillGv();
            }
