<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AltiSubjRegestrationAcceptEmp.aspx.cs" Inherits="WebApplication1.AltiSubjRegestrationAcceptEmp" %>
    ...
    <form id="form1" runat="server">
         <asp:GridView ID="gvAlternativeSubject" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" OnRowCommand="gvAlternativeSubject_RowCommand"  Width="100%" CellPadding="4" ForeColor="#1A7BB9" GridLines="None" >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DeputyAcademic" HeaderText="قرار المرشد الاكاديمي" SortExpression="DeputyAcademic" />
