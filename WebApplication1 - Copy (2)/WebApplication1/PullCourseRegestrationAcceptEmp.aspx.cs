...
{
    public partial class PullCourseRegestrationAcceptEmp : System.Web.UI.Page
    {
        ...
        private void fillGv()
        {
            ...
            DataTable TBL1 = obj.dtNotPullCourseRegApplication();
        ...
        public void NotAccept(int ID)
        {
            ...
            if (obj.NotAcceptRegPullCourse(ID) == 1)
            {
                fillGv();
            }
