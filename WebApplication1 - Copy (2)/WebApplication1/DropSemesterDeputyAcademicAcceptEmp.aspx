<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DropSemesterDeputyAcademicAcceptEmp.aspx.cs" Inherits="WebApplication1.DropSemesterDeputyAcademicAcceptEmp" %>
      ...
      <asp:GridView ID="gvDropSemester" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" OnRowCommand="gvDropSemester_RowCommand" Width="100%" CellPadding="4" ForeColor="#1A7BB9" GridLines="None" >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DeanDescription" HeaderText="ملاحظات العميد" SortExpression="DeanDescription" />
                                         <asp:BoundField DataField="DeputyAcademicAccept" HeaderText="قرار النائب الأكاديمي" SortExpression="DeputyAcademicAccept" />
                                         <asp:BoundField DataField="DeputyAcademic_Descr" HeaderText="ملاحظات النائب الأكاديمي" SortExpression="DeputyAcademic_Descr" />
