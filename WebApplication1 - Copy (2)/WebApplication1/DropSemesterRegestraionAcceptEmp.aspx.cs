...
{
    public partial class DropSemesterRegestraionAcceptEmp : System.Web.UI.Page
    {
        ...
        private void fillGv()
        {
            ...
            DataTable TBL1 = obj.dtNotAcceptDropSemesterRegApplication();
        ...
        public void Accept(int ID)
        {
            ...
            if (obj.AcceptRegDropSemester(ID) == 1)
            {
                fillGv();
            }
        ...
        public void NotAccept(int ID)
        {
            ...
            if (obj.NotAcceptRegDropSemester(ID) == 1)
            {
                fillGv();
            }
