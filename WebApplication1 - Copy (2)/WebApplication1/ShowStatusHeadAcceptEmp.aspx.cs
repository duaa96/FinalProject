...
{
    public partial class ShowStatusHeadAcceptEmp: System.Web.UI.Page
    {
        ...
        private void fillGv()
        {
            ...
            DataTable TBL1 = obj.dtNotShowStatusHeadApplication();
        ...
        public void Accept(int ID)
        {
            ...
            if (obj.AcceptHeadShowStatus(ID) == 1)
            {
                fillGv();
            }
        ...
        public void NotAccept(int ID)
        {
            ...
            if (obj.NotAcceptHeadShowStatus(ID) == 1)
            {
                fillGv();
            }
