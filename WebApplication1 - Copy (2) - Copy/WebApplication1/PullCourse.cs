...
public class PullCourse
{
    ...
    {
        string Query = "INSERT INTO PullCourse(StudentID,YearSemester,Subject1ID,Subject2ID,Subject3ID,Date ,Description, HeadDescription, HeadDate,HeadAccept,DeanDescription,DeanDate, DeanAccept, RegestrationAccept, ApplicationID)VALUES(@StudentID,@YearSemester,@Subject1ID,@Subject2ID,@Subject3ID,@Date ,@Description,@HeadDescription,string HeadDate,@HeadAccept,@DeanDescription,@DeanDate,@DeanAccept,@RegestrationAccept,@ApplicationID) ";
